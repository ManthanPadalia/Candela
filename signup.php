...
<body>
    <div class="navbar">
      <img src="candela_logo.png" height="50px">
    </div>
    <div class="main1">
        ...
        <div class="login-container">
            <form action="#" method="post">
                ...
                <div class="input-field">
                    <label for="username" style="font-weight: 600;">Username</label><br>
                ...
                <div class="input-field">
                    <label for="password" style="font-weight: 600;">Confirm Password:</label><br>
